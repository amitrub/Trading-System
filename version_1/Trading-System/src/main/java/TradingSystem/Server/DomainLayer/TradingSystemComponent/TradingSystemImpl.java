...
//            tradingSystemImpl.Initialization();
    ...
    public Response AddStore(int userID, String connID, String storeName){
        if(!ValidConnectedUser(userID,connID)){
            ...
            if (validation.IsStoreNameExist(storeName)){
                ...
                return new Response( "AddStore: Add store " + storeName + " was successful");
            }
        }
    }
    ...
    public Response WriteComment(int userId, String connID, int storeId, int productId, String comment) {
        ...
        return new Response(false, "WriteComment: The comment added successfully to product " + productId);
    }
...
//                System.out.println(ANSI_BLUE + "???? userID try to lock: " + userID + ANSI_RESET);
        ...
        NO.unlockUser();
        return new Response(false, "AddNewOwner: The owner Added successfully");
    }
    ...
    public Response RemoveOwnerByOwner(int ownerID, String connID, int removeOwnerID, int storeID) {
        ...
        return new Response(false, "RemoveOwnerByOwner: Successfully removed the owner " + removeOwnerID);
    }
    ...
    public Response AddNewManager(int userID, String connID, int storeID, int newManager) {
        ...
        NM.unlockUser();
        return new Response(false, "AddNewManager: The manager Added successfully");
    }
    ...
    public Response EditManagerPermissions(int userID, String connID, int storeID, int managerID, List<User.Permission> permissions) {
        ...
        //NM.unlockUser();
        return new Response(false, "EditManagerPermissions:: The permissions of manager" + managerID + "edit successfully");
    }
...
//                System.out.println(ANSI_BLUE + "???? userID try to lock: " + userID + ANSI_RESET);
        ...
        MTR.unlockUser();
        return new Response(false, "RemoveManager: The manager removed successfully");
    }
